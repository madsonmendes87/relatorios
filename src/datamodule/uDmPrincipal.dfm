object dmPrincipal: TdmPrincipal
  ...
  object qryEmpArtigos: TFDQuery
    Connection = dmConexao.Conexao
    Left = 72
    Top = 408
  end
  object dsEmpArtigos: TDataSource
    DataSet = qryEmpArtigos
    Left = 160
    Top = 408
  end
  ...
  object qryTotReservaTecido: TFDQuery
    Connection = dmConexao.Conexao
    Left = 72
    Top = 472
  end
  object dsTotReservaTecido: TDataSource
    DataSet = qryTotReservaTecido
    Left = 192
    Top = 472
  end
  object qryReservaArtigo: TFDQuery
    Connection = dmConexao.Conexao
    Left = 472
    Top = 408
  end
  object dsReservaArtigo: TDataSource
    DataSet = qryReservaArtigo
    Left = 576
    Top = 408
  end
  object qryTotReservaArtigo: TFDQuery
    Connection = dmConexao.Conexao
    Left = 312
    Top = 472
  end
  object dsTotReservaArtigo: TDataSource
    DataSet = qryTotReservaArtigo
    Left = 440
    Top = 472
  end
