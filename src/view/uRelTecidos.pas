...
begin
    ...
    rlDBComposicao.DataField              :='cm_descricao';
     ...
     begin
          ...
          SQL.Add('     cc.comp_id,');
          SQL.Add('     COALESCE(cc.comp_nome, ''SEM IDENTIFICAÇÃO'') AS comp_nome,');
          ...
          SQL.Add('               )');
          SQL.Add('         ) OVER (');
          SQL.Add('               PARTITION BY cc.comp_id');
          SQL.Add('         ) AS total_disponivel_comprador,');
          SQL.Add('     SUM(');
          SQL.Add('               (');
          SQL.Add('                       (');
          SQL.Add('                               COALESCE(e.es_entradaforn,0.0000) -');
          ...
          begin
              SQL.Add('AND cc.comp_id = :idComprador');
              ParamByName('idComprador').AsInteger :=frmFiltroArtigo.dblcbComprador.KeyValue;
          end;

          if frmFiltroArtigo.dblcbFornecedor.KeyValue <> Null then
          begin
              SQL.Add('AND f.for_codigo = :idFornecedor');
              ParamByName('idFornecedor').AsInteger :=frmFiltroArtigo.dblcbFornecedor.KeyValue;
          end;
     ...
     rlDBTotal.DataSource                 :=dmPrincipal.dsEstTecidos;
     rlDBTotal.DataField                  :='total_disponivel_comprador';
