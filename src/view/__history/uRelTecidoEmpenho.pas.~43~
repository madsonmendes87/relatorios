...
begin
    ...
    rlDBRef.DataSource                   :=dmPrincipal.dsEmpTecidos;
    rlDBRef.DataField                    :='cad_idreferencia';

    rlDBOrdCorte.DataSource              :=dmPrincipal.dsEmpTecidos;
    rlDBOrdCorte.DataField               :='emp_idordemcorte';

    rlDBOrdProducao.DataSource           :=dmPrincipal.dsEmpTecidos;
    rlDBOrdProducao.DataField            :='emp_idordproducao';

    rlDBCor.DataSource                   :=dmPrincipal.dsEmpTecidos;
    rlDBCor.DataField                    :='grc_nome';

    rlDBTamanho.DataSource               :=dmPrincipal.dsEmpTecidos;
    rlDBTamanho.DataField                :='grt_nome';

    rlDBRolo.DataSource                  :=dmPrincipal.dsEmpTecidos;
    rlDBRolo.DataField                   :='es_numrolo';

    rlDBTipo.DataSource                  :=dmPrincipal.dsEmpTecidos;
    rlDBTipo.DataField                   :='tipo';

    rlDBSitEmp.DataSource                :=dmPrincipal.dsEmpTecidos;
    rlDBSitEmp.DataField                 :='situacao_empenho';

    rlDBConsumo.DataSource               :=dmPrincipal.dsEmpTecidos;
    rlDBConsumo.DataField                :='saldo';

    rlDBTotal.DataSource                 :=dmPrincipal.dsEmpTecidos;
