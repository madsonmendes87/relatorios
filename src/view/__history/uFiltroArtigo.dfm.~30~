object frmFiltroArtigo: TfrmFiltroArtigo
  ...
  object btnZeraTamanho: TSpeedButton
    Left = 695
    Top = 85
    Width = 23
    Height = 23
  ...
  object btnZeraComprador: TSpeedButton
    Left = 176
    Top = 152
    Width = 23
    Height = 22
    ...
    Font.Style = [fsBold]
    ParentFont = False
    OnClick = btnZeraCompradorClick
  end
  object lblTipoReserva: TLabel
    Left = 200
    Top = 131
    Width = 98
    Height = 15
  ...
  object lblCheck1: TLabel
    ...
    Width = 181
    Height = 15
    Caption = 'PROT'#211'TIPOS E QUE N'#195'O TENHA'
    Font.Charset = DEFAULT_CHARSET
    Font.Color = clWindowText
    Font.Height = -12
    Font.Name = 'Segoe UI'
  ...
  object btnZeraFornecedor: TSpeedButton
    Left = 176
    Top = 217
    Width = 23
    Height = 22
    ...
    Font.Style = [fsBold]
    ParentFont = False
    OnClick = btnZeraFornecedorClick
  end
  object lblTipoEmpenho: TLabel
    Left = 200
    Top = 195
    Width = 105
    Height = 15
  ...
  object dblcbCor: TDBLookupComboBox
    Left = 200
    Top = 85
    Width = 209
    Height = 23
    ...
    ListSource = dmPrincipal.dsGrc
    TabOrder = 2
  end
  object dblcbTamanho: TDBLookupComboBox
    Left = 448
    Top = 85
    Width = 249
    Height = 23
    KeyField = 'grt_id'
    ListField = 'grt_nome'
    ListSource = dmPrincipal.dsTamanho
    TabOrder = 3
  end
  object dblcbComprador: TDBLookupComboBox
    Left = 8
    Top = 152
    Width = 167
    Height = 23
    KeyField = 'comp_id'
    ListField = 'comp_nome'
    ListSource = dmPrincipal.dsComprador
    TabOrder = 4
  end
  ...
  object cboTipoEmpenho: TComboBox
    Left = 200
    Top = 217
    Width = 185
    Height = 23
  ...
  object pnlVisualEmpenho: TPanel
    Left = 138
    Top = 304
    Width = 120
    Height = 31
